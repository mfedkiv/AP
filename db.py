...
calendar_users_1 = CalendarUsers(calendar_id=1, user_id=1)
calendar_users_2 = CalendarUsers(calendar_id=1, user_id=2)
calendar_users_3 = CalendarUsers(calendar_id=1, user_id=3)
calendar_users_4 = CalendarUsers(calendar_id=2, user_id=4)
calendar_users_5 = CalendarUsers(calendar_id=3, user_id=1)
...
calendar_users = [calendar_users_1, calendar_users_2, calendar_users_3, calendar_users_4, calendar_events_5]
...
session.add_all(calendar_users)
# session.commit()
